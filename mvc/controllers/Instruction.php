        ...
        if(permissionChecker('instruction_view')) {
            ...
            if((int)$id !== 0) {
                ...
                if(inicompute($this->data['instruction'])) {
                    ...
                    $this->reportPDF('instruction.css',$this->data, 'online_exam/instruction/print_preview');
                } else {
                    $this->data["subview"] = "error";
                    $this->load->view('_layout_main', $this->data);
                }
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    if ((int)$id !== 0) {
                        ...
                        if($this->data['instruction']) {
                            ...
                            $this->reportSendToMail('instruction.css',$this->data['instruction'], 'online_exam/instruction/print_preview', $email, $subject, $message);
