            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="mark" name="mark" value="<?=set_value('mark', $question_bank->mark != null ? $question_bank->mark : 0)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("type", $array, set_value("type",$question_bank->typeNumber), "id='type' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("totalOption", $array, set_value("totalOption", $question_bank->totalOption), "id='totalOption' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
...
<script type="text/javascript">
    ...
    function formHtmlData(id, type, value='', checked='', nilaijawaban='') {
        ...
        if(type == 1) {
            ...
            var html = '<div class="form-group coption">'
         + '<label for="option' + id + '" class="col-sm-2 control-label"><?=$this->lang->line("question_bank_option")?> ' + id + '</label>'
         ...
         + '<input type="file" name="image' + id + '" id="image' + id + '">'
         + '</div>'
         + '<div class="col-sm-2" style="display:inline-table">'
         + '<input type="number" required class="form-control" id="number' + id + '" name="numberanswer[]" value="' + nilaijawaban + '" placeholder="Nilai Jawaban">'
         + '</div>'
...
<?php
    if(inicompute($options) || inicompute($answers)|| inicompute($nilaijawaban)) {
        if($typeID == 3) {
            $options =  $answers;
        } else {
            $options =  $options;
        ...
        foreach ($options as $optionKey => $optionValue) {
            ...
            <script type="text/javascript">
                ...
                var optNilJaw = '<?=$nilaijawaban[$optionKey]?>';
                var optAns = '<?=(inicompute($answers) && in_array($optionKey, $answers)) ? 'checked="checked"' : ''?>';

                $('#in').append(formHtmlData(optID, optTypeID, optVal, optAns,optNilJaw));
